...
%for l = 1:t
    ...
    disp(M(l));
    disp(N(l));
	[e_f,e_a,e_c,e_d,e_b,e_e,t_f,t_a,t_c,t_d,t_b,t_e] = error_3x6x3_real(A,B,n_0);
...
save('accuracy_3x6x3_real','M','N','E_f','E_a','E_c','E_d','E_b','E_e');
save('accuracy_3x6x3_real.txt','M','N','E_f','E_a','E_c','E_d','E_b','E_e','T_f','T_a','T_c','T_d','T_b','T_e',"-ascii","-double");
