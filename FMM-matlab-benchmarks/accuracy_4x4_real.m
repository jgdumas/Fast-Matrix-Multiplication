...
rng(1);
t = 60;   % Number of points : 60
num = 7;  % Number of runs for each point : 7
n_0 = 1;  % Basecase of the recursion : 1
n_b = 24; % Smallest matrix dimension : 24
inc = 8; % Matrix dimension increment : 8
