...
parfor l = 1:t
    ...
    for k = 1:num
        ...
        B = gen_mat_SW(n);
        [e_w,e_s,e_v4,e_o,e_a,e_f,e_8,t_w,t_s,t_v4,t_o,t_a,t_f,t_8] = error_4x4_real(A,B,n_0);
...
save('accuracy_4x4_real','N','m','E_W','E_S','E_O','E_A','E_F','E_4','E_8','T_W','T_S','T_O','T_A','T_F','T_4','T_8');
save('accuracy_4x4_real.txt','N','m','E_W','E_S','E_O','E_A','E_F','E_4','E_8','T_W','T_S','T_O','T_A','T_F','T_4','T_8',"-ascii","-double");
fprintf(" ... done.\n");
