...
save('accuracy_alternate_real','N','m','E_S','E_1','E_W','E_K','E_4','E_O','E_8','T_S','T_1','T_W','T_K','T_4','T_O','T_8');
save('accuracy_alternate_real.txt','N','m','E_S','E_1','E_W','E_K','E_4','E_O','E_8','T_S','T_1','T_W','T_K','T_4','T_O','T_8',"-ascii","-double");
