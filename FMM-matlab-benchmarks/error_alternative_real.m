function [e_s,e_1,e_w,e_ks,e_v4,e_vk,e_8,t_s,t_1,t_w,t_ks,t_v4,t_vk,t_8] = error_alternative_real(A,B,n_0)
    ...
    tic
    C_1 = Strassen_alternative(A,B,n_0);
    t_1 = toc;
    ...
    tic
    C_ks = Winograd_alternative(A,B,n_0);
    t_ks = toc;
