...
for l = 1:t
    ...
    disp(M(l));
    disp(N(l));
	[e_f,e_a,e_c,e_d,t_f,t_a,t_c,t_d] = error_3x3x6_real(A,B,n_0);
...
save('accuracy_3x3x6_real','M','N','E_f','E_a','E_c','E_d');
save('accuracy_3x3x6_real.txt','M','N','E_f','E_a','E_c','E_d','T_f','T_a','T_c','T_d',"-ascii","-double");
